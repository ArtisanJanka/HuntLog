<x-app-layout>
    <div class="max-w-md mx-auto p-6">
        <h1 class="text-2xl font-semibold text-white mb-4">Edit Type</h1>
        <form method="POST" action="{{ route('admin.types.update', $type) }}" class="space-y-4">
            @csrf @method('PUT')
            <div>
            ...
            <div>
                <label class="block text-gray-300 mb-1">Slug (optional)</label>
            ...
            <div class="flex justify-end gap-2">
                <a href="{{ route('admin.types.index') }}" class="px-4 py-2 bg-gray-700 rounded text-white">Cancel</a>
