...
<body class="min-h-full text-white antialiased overflow-x-hidden">
    ...
    <header class="relative z-20">
        <div class="mx-auto max-w-7xl px-6 pt-6">
            <div class="header-shell flex items-center justify-between px-4 py-3 sm:px-5">
                <a href="{{ url('/') }}"
                   class="font-extrabold tracking-wider transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 rounded text-emerald-400 hover:text-emerald-300 text-xl">
                    HuntLog
                </a>
                ...
                <div class="flex items-center gap-3">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="focus-outline tiny-btn tiny-btn-primary">
                                Doties uz paneli
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="focus-outline tiny-btn tiny-btn-secondary">
                                Pieteikties
                            </a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="focus-outline tiny-btn tiny-btn-primary">
                                    Reģistrēties
                                </a>
                            @endif
                        @endauth
    ...
    <main>
        ...
        <section class="relative">
            <div class="mx-auto max-w-7xl px-6 pb-20 pt-14 sm:pt-16 lg:pb-28">
                <div class="mx-auto max-w-4xl text-center animate-fadeUp">
                    <span class="hero-kicker">Jauna paaudze medību žurnālam</span>

                    <h1 class="hero-title mt-7 text-5xl font-black leading-[0.96] tracking-tight sm:text-6xl lg:text-7xl">
                    ...
                    <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
                        <a href="{{ route('register') }}" class="focus-outline btn-primary">
                            Sākt lietot
                        ...
                        <a href="{{ route('gallery') }}" class="focus-outline btn-secondary">
                            Apskatīt galeriju
                        </a>
                    </div>
                </div>

                <div class="relative mx-auto mt-16 max-w-5xl animate-fadeUp" style="animation-delay:.12s;">
                    <div class="preview-shell">
                        <div class="preview-topbar flex items-center justify-between px-5 py-4">
                            ...
                            <div class="rounded-full bg-white/10 px-3 py-1 text-xs text-white/60">huntlog.app</div>
                        </div>
                        <img
                            ...
                            alt="HuntLog preview"
                            class="hero-preview-image h-[320px] sm:h-[420px] lg:h-[560px]"
                        >
                    </div>
        ...
        <section class="light-panel text-slate-900">
            <div class="mx-auto max-w-7xl px-6 pb-20 pt-16 sm:pt-20">
                <div class="mx-auto max-w-3xl text-center">
                    <span class="section-kicker-light">Par platformu</span>
                    <h2 class="mt-6 text-4xl font-black tracking-tight sm:text-5xl">
                ...
                <div class="mt-14 grid items-center gap-10 lg:grid-cols-[1.05fr_.95fr]">
                    <div class="light-card overflow-hidden p-3">
                        <img
                            src="{{ asset('storage/images/phone.jpg') }}"
                            alt="HuntLog content preview"
                            class="h-[280px] w-full rounded-2xl object-cover sm:h-[360px]"
                        >
                    </div>
                ...
                <div class="mt-16 overflow-hidden rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-sky-50 px-8 py-14 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
                    <div class="max-w-3xl">
                        <span class="section-kicker-light">Gatavs sākt?</span>
                        <h3 class="mt-6 text-4xl font-black tracking-tight sm:text-5xl">
                        ...
                        <div class="mt-8 flex flex-wrap gap-4">
                            <a href="{{ route('register') }}" class="focus-outline btn-primary">Reģistrēties</a>
                            <a href="{{ route('login') }}" class="focus-outline btn-secondary !text-slate-800 !border-slate-200 !bg-white hover:!text-emerald-700 hover:!border-emerald-200">
                                Pieteikties
                            </a>
                        </div>
                    </div>
    ...
    <footer class="border-t border-white/10 bg-black/30 backdrop-blur">
        <div class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-5 px-6 py-8 text-sm text-gray-400 md:flex-row">
