@props([
    ...
    'width' => '48',        // tailwind width key, e.g. 48 => w-48
    'contentClasses' => '', // extra classes for the inner content wrapper
])
...
<div x-data="{ open:false }" class="relative">
    ...
    {{-- Backdrop (no color so it won’t show a white block) --}}
    <div x-cloak
         x-show="open"
    ...
    <div x-cloak
        ...
        {{-- Content shell (✨ dark glass, NO white bg) --}}
